        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, paddingBottom: 10 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button
                onClick={e => { e.stopPropagation(); if(news.symbol && news.symbol !== "MARKET" && window.__setActiveFilter) { window.__setActiveFilter(news.symbol); } else { openDetailPage("performance"); } }}
                style={{
                  flex: 1, padding: "7px 0", borderRadius: 8,
                  fontSize: 11, fontWeight: 600, fontFamily: "var(--font-display)",
                  cursor: "pointer",
